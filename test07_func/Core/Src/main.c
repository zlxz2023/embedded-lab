...
void LCD_Proc(){
    if(page==0){
        sprintf(text, "r37:%.2f", GET_Vol(&hadc2));
        LCD_DisplayStringLine(Line3, (uint8_t*)text);
        HAL_ADC_Start(&hadc1);
        sprintf(text, "r38:%.2f", GET_Vol(&hadc1));
        ...
        sprintf(text, "     count1:%03d     ", count1);
        ...
        sprintf(text, "     count2:%03d     ", count2);
        ...
        sprintf(text, "     count3:%03d     ", count3);
